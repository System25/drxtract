...
from lingosrc.ast import Statement, Sprite, StringOperationNames, \
...
class AssignSpecialPropertiesOpcode(SpecialPropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        SpecialPropertiesOpcode.process(self, context, stack, statements_list, \
                                        index)
...
class AssignMenuitemPropertiesOpcode(MenuitemPropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        MenuitemPropertiesOpcode.process(self, context, stack, statements_list, \
                                         index)
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
        op.right = stack.pop()
...
class AssignSpritePropertiesOpcode(SpritePropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        SpritePropertiesOpcode.process(self, context, stack, statements_list, \
                                       index)
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
        op.right = stack.pop()
...
class AssignSystemPropertiesOpcode(SystemPropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        SystemPropertiesOpcode.process(self, context, stack, statements_list, \
                                       index)
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
        op.right = stack.pop()
...
class AssignCastPropertiesOpcode(CastPropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        CastPropertiesOpcode.process(self, context, stack, statements_list, \
                                     index)
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
        op.right = stack.pop()
...
class AssignVideoPropertiesOpcode(VideoPropertiesOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        VideoPropertiesOpcode.process(self, context, stack, statements_list, \
                                      index)
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
        op.right = stack.pop()
...
class AssignPropertyAccesorOpcode(PropertyAccesorOpcode):
    ...
    def process(self, context: Context, stack: List[Node], \
                statements_list: List[Statement], index: int):
        PropertyAccesorOpcode.process(self, context, stack, statements_list, \
                                      index)
        value = stack.pop()
        op = BinaryOperation(BinaryOperationNames.ASSIGN, index)
        op.left = stack.pop()
