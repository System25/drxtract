...
from lingosrc.ast import Script, Function, Node
from lingosrc.model import Context, Header
from lingosrc.util import escape_string, unpack_float80
from lingosrc.opcodes import OPCODES, Opcode, BiOpcode, TriOpcode, \
...
def parse_frb(fdata: bytes, header: Header, context: Context, script: Script):
    ...
    for i in range(0, header.frb_nrecords):
        ...
        for nl in range(0, bc_nlocal):
            ...
            function.local_vars.append(context.name_list[n])
        ...
        for nl in range(0, bc_narg):
            ...
            function.parameters.append(context.name_list[n])
        ...
        if opcode in OPCODES.keys():
            ...
            if parse_obj.nbytes == 2:
                ...
                if isinstance(parse_obj, TriOpcode):
                    parse_obj = TRI_OPCODES[opcode * 65536 + opcode2 * 256
                                            + opcode3]
                else:
