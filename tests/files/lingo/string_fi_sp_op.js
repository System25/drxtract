function exitFrame() {
    ...
    field(2).text.item[1] = new LingoString(new LingoString("hey") + field(2).text.item[1]);
    put(field(2));
    field(2).text.item[1] = new LingoString(field(2).text.item[1] + new LingoString("you"));
    put(field(2));
