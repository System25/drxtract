function exitFrame() {
    ...
    _global.myStr.item[1] = new LingoString(new LingoString("hey") + _global.myStr.item[1]);
    put(_global.myStr);
    _global.myStr.item[1] = new LingoString(_global.myStr.item[1] + new LingoString("you"));
    put(_global.myStr);
