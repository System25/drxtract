...
class TestScript(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ['string_op.Lnam', 'string_op.Lscr', 'string_op.js'],
        ['immediate.Lnam', 'immediate.Lscr', 'immediate.js'],
        ['labels.Lnam', 'labels.Lscr', 'labels.js'],
        ['lastp.Lnam', 'lastp.Lscr', 'lastp.js'],
        ['mtype.Lnam', 'mtype.Lscr', 'mtype.js'],
        ['mousep.Lnam', 'mousep.Lscr', 'mousep.js'],
        ['keyp.Lnam', 'keyp.Lscr', 'keyp.js'],
        ['moviep.Lnam', 'moviep.Lscr', 'moviep.js'],
        ['nothing.Lnam', 'nothing.Lscr', 'nothing.js'],
        ['castnum.Lnam', 'castnum.Lscr', 'castnum.js'],
        ['pause.Lnam', 'pause.Lscr', 'pause.js'],
        ['result.Lnam', 'result.Lscr', 'result.js'],
        ['select.Lnam', 'select.Lscr', 'select.js'],
        ['stagep.Lnam', 'stagep.Lscr', 'stagep.js'],
